...
import 'package:kapheapp/features/shop/product_reviews/widgets/progress_indicator_and_rating.dart';
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        Expanded(
          flex: 3,
          child: Text('4.3', style: Theme.of(context).textTheme.displayLarge),
        ),
        const Expanded(
          flex: 7,
          child: Column(
